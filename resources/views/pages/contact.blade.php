...
@section('content')
<!-- Hero Section -->
<section class="relative pt-24 pb-12 px-container-margin w-full overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
            <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-surface-container/80 backdrop-blur-md border border-secondary-fixed/20 text-secondary-fixed font-label-caps text-label-caps mb-4 shadow-[0_0_15px_rgba(203,163,88,0.15)]">
                <span class="material-symbols-outlined text-sm">support_agent</span>
                24/7 SUPPORT NETWORK
            </div>
            <h1 class="font-display-md text-[36px] md:text-[48px] text-white font-semibold mb-6 leading-tight">
                Connect with the <span class="text-secondary-fixed italic font-light drop-shadow-[0_0_20px_rgba(203,163,88,0.3)]">Source</span>
            </h1>
            <p class="font-body-md text-lg text-on-surface-variant leading-relaxed pr-8 mb-10">
            ...
            <div class="flex flex-col gap-8">
                <div class="flex items-center gap-5">
                    <div class="w-14 h-14 shrink-0 rounded-2xl bg-white/5 flex items-center justify-center border border-white/10 backdrop-blur-md shadow-[0_0_15px_rgba(0,0,0,0.2)]">
                        <span class="material-symbols-outlined text-white text-[24px]">location_on</span>
                    </div>
                    <div>
                        <h4 class="font-label-caps text-[12px] text-on-surface-variant tracking-widest uppercase mb-1">Global Headquarters</h4>
                        <p class="font-body-md text-white text-lg">LPU, Phagwara, Punjab 144411</p>
                    </div>
                </div>
                
                <div class="flex items-center gap-5">
                    <div class="w-14 h-14 shrink-0 rounded-2xl bg-secondary-container/10 flex items-center justify-center border border-secondary-fixed/20 backdrop-blur-md shadow-[0_0_15px_rgba(203,163,88,0.1)]">
                        <span class="material-symbols-outlined text-secondary-fixed text-[24px]">mail</span>
                    </div>
                    <div>
                        <h4 class="font-label-caps text-[12px] text-on-surface-variant tracking-widest uppercase mb-1">Digital Channels</h4>
                ...
                <div class="flex items-center gap-5">
                    <div class="w-14 h-14 shrink-0 rounded-2xl bg-primary-container/10 flex items-center justify-center border border-primary-fixed/20 backdrop-blur-md shadow-[0_0_15px_rgba(6,205,172,0.1)]">
                        <span class="material-symbols-outlined text-primary-fixed text-[24px]">call</span>
                    </div>
                    <div>
                        <h4 class="font-label-caps text-[12px] text-on-surface-variant tracking-widest uppercase mb-1">Direct Communications</h4>
                        <p class="font-body-md text-white text-lg">+91 7004545150<br><span class="text-on-surface-variant text-sm mt-0.5 block">Mon-Sun, 10:00 AM - 6:00 PM IST</span></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="relative">
            ...
            <div class="bg-surface-container-low/90 backdrop-blur-2xl border border-white/10 shadow-[0_20px_40px_rgba(0,0,0,0.4)] rounded-[32px] p-6 md:p-8 relative z-10 overflow-hidden">
                <!-- Decorative top bar -->
                <div class="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-primary-fixed via-secondary-fixed to-tertiary"></div>
                
                <h3 class="font-headline-md text-[24px] text-white mb-1">Initialize Transmission</h3>
                <p class="font-body-md text-sm text-on-surface-variant mb-6">Our routing algorithm will connect you with the right specialist.</p>
                ...
                <form action="{{ route('contact.submit') }}" method="POST" class="flex flex-col gap-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex flex-col gap-1.5 group">
                            ...
                            <input type="text" name="first_name" class="bg-surface/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-secondary-fixed focus:bg-surface/80 transition-all w-full shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]" placeholder="John" required>
                        </div>
                        <div class="flex flex-col gap-1.5 group">
                            ...
                            <input type="text" name="last_name" class="bg-surface/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-secondary-fixed focus:bg-surface/80 transition-all w-full shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]" placeholder="Doe" required>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-1.5 group">
                        ...
                        <input type="email" name="email" class="bg-surface/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-secondary-fixed focus:bg-surface/80 transition-all w-full shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]" placeholder="transmission@example.com" required>
                    </div>
                    ...
                    <div class="flex flex-col gap-1.5 group">
                        ...
                        <div class="relative">
                            <select name="department" class="bg-surface/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-secondary-fixed focus:bg-surface/80 transition-all w-full appearance-none shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]">
                    ...
                    <div class="flex flex-col gap-1.5 group">
                        ...
                        <textarea name="message" rows="3" class="bg-surface/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-secondary-fixed focus:bg-surface/80 transition-all w-full resize-none shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]" placeholder="State your inquiry..." required></textarea>
                    </div>
                    
                    <button type="submit" class="bg-secondary-fixed text-surface-container-lowest font-label-caps text-[14px] tracking-widest px-8 py-4 rounded-xl hover:shadow-[0_0_30px_rgba(203,163,88,0.4)] transition-all flex items-center justify-center gap-2 mt-2 w-full hover:-translate-y-1">
                        SEND MESSAGE
