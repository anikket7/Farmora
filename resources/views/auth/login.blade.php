        ...
        <div class="w-full max-w-4xl grid md:grid-cols-2 gap-0 rounded-xl overflow-hidden shadow-[0_16px_64px_-12px_rgba(203,163,88,0.1)] border border-white/10 backdrop-blur-3xl bg-surface-container/30">
            ...
            <div class="p-card-padding md:p-8 flex flex-col h-full bg-surface-container/20">
                <div class="mb-8 text-center md:text-left">
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant">Sign in to your Farmora account.</p>
                </div>

                <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-6 grow">
                    @csrf
                    ...
                    <div class="flex flex-col gap-2">
                        <label for="password" class="font-label-caps text-label-caps text-on-surface-variant pl-4">Password</label>
                        <div class="relative">
                    ...
                    <div class="flex items-center justify-between px-2">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="remember" class="w-4 h-4 rounded border-white/20 bg-surface-container-low text-secondary-fixed focus:ring-secondary-fixed/50">
                            <span class="font-body-md text-sm text-on-surface-variant">Remember me</span>
                        </label>
                        <a href="{{ route('password.request') }}" class="font-body-md text-sm text-secondary-fixed hover:text-white transition-colors">Forgot password?</a>
                    </div>
                ...
                <div class="mt-6 text-center">
                    <p class="font-body-md text-sm text-on-surface-variant">Don't have an account? <a href="{{ route('register') }}" class="text-secondary-fixed hover:text-white transition-colors">Register here</a></p>
                </div>
